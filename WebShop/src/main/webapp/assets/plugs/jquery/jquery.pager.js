(function($) {     
    ...
    function renderpager(pagenumber, pagecount, buttonClickCallback) {           
        ...
        var strgoto = $("<li class='thpoint'>当前<input type='text' value='"+pagenumber+"'maxlength='6' id='gotoval' style='width:30px; height:20px;margin-top:-3px;padding-top:2px;padding-left:10px;'/>页</li>");  
