...
!function () {
  ...
  var specialKeys = {
    ...
    Copy: {t: "Copy"},
    Paste: {t: "Paste"},
    Pastetext: {t: "Pastetext", h: isIE ? 0 : 1},
    Blocktag: {t: "Blocktag", h: 1},
    Fontface: {t: "Fontface", h: 1},
    FontSize: {t: "FontSize", h: 1},
    Bold: {t: "Bold", s: "Ctrl+B"},
    Italic: {t: "Italic", s: "Ctrl+I"},
    Underline: {t: "Underline", s: "Ctrl+U"},
    Strikethrough: {t: "Strikethrough"},
    FontColor: {t: "FontColor", h: 1},
    BackColor: {t: "BackColor", h: 1},
    SelectAll: {t: "SelectAll"},
    Removeformat: {t: "Removeformat"},
    Align: {t: "Align", h: 1},
    List: {t: "List", h: 1},
    Outdent: {t: "Outdent"},
    Indent: {t: "Indent"},
    Link: {t: "Link", s: "Ctrl+L", h: 1},
    Unlink: {t: "Unlink"},
    Anchor: {t: "Anchor", h: 1},
    Img: {t: "Img", h: 1},
    Flash: {t: "Flash", h: 1},
    Media: {t: "Media", h: 1},
    Hr: {t: "Hr"},
    Emot: {t: "Emot", s: "ctrl+e", h: 1},
    Table: {t: "Table", h: 1},
    Source: {t: "Source"},
    Preview: {t: "Preview"},
    Print: {t: "Print", s: "Ctrl+P"},
    Fullscreen: {t: "Fullscreen", s: "Esc"},
    About: {t: "About"}
  }, toolsThemes = {
  ...
  var arrDbClick = {a: "Link", img: "Img", embed: "Embed"}, uploadInputname = "filedata", arrEntities = {
    "<": "&lt;",
    ">": "&gt;",
    '"': "&quot;",
    "庐": "&reg;",
    "漏": "&copy;"
  }, regEntities = /[<>"庐漏]/g, Xheditor = function (textarea, options) {
    function checkDblClick(a) {
      var b = a.target, c = arrDbClick[b.tagName.toLowerCase()];
      if (c) {
        if ("Embed" === c) {
          var d = {"application/x-shockwave-flash": "Flash", "application/x-mplayer2": "Media"};
    ...
    function cleanPaste(a) {
      ...
      if (a && (b = a.originalEvent.clipboardData) && (c = b.items) && (d = c[0]) && "file" == d.kind && d.type.match(/^image\//i)) {
        var e = d.getAsFile(), f = new FileReader;
      ...
      var h = isIE ? "pre" : "div", i = $("<" + h + ' class="xhe-paste">\ufeff\ufeff</' + h + ">", _doc).appendTo(_doc.body), j = i[0], k = _this.getSel(), l = _this.getRng(!0);
    ...
    function replaceRemoteImg(a) {
      var b = settings.localUrlTest, c = settings.remoteImgSaveUrl;
      if (b && c) {
        var d = [], e = 0;
        ...
        }), d.length > 0 && $.post(c, {urls: d.join("|")}, function (a) {
    ...
    function fixAppleSel(a) {
      if (a = a.target, a.tagName.match(/(img|embed)/i)) {
        var b = _this.getSel(), c = _this.getRng(!0);
    ...
    function getLocalUrl(a, b, c) {
      ...
      var d = c ? $('<a href="' + c + '" />')[0] : location, e = d.protocol, f = d.host, g = d.hostname, h = d.port, i = d.pathname.replace(/\\/g, "/").replace(/[^\/]+$/i, "");
    ...
    function formatBytes(a) {
      var b = ["Byte", "KB", "MB", "GB", "TB", "PB"], c = Math.floor(Math.log(a) / Math.log(1024));
    ...
    this.init = function () {
      ...
      var b = _jText.outerWidth(), c = _jText.outerHeight(), d = settings.width || _text.style.width || (b > 10 ? b : 0);
      ...
      $.each(settings.tools, function (a, b) {
        if (b.match(i) && h.push('<span class="xheGEnd"/>'), "|" === b)h.push('<span class="xheSeparator"/>'); else if ("/" === b)h.push("<br />"); else {
      ...
      if (j)if (is(j, "array"))for (var k in j)headHTML += '<link rel="stylesheet" href="' + j[k] + '"/>'; else headHTML += j.match(/\s*<style(\s+[^>]*?)?>[\s\S]+?<\/style>\s*/i) ? j : '<link rel="stylesheet" href="' + j + '"/>';
      ...
      setTimeout(setOpts, 300), _this.setSource(), _win.setInterval = null, _jTools.append(getLang(h.join(""))).bind("mousedown contextmenu", returnFalse).click(function (a) {
        ...
        var b = a.which;
        if (27 == b)_jTools.find("a").attr("tabindex", "-1"), _this.focus(); else if (a.altKey && b >= 49 && 57 >= b)return _jTools.find(".xheGStart").eq(b - 49).next().find("a").focus(), !1
      });
      ...
      if (!bSource) {
        _this.focus();
        var a = _this.getRng();
        a = a.cloneRange ? a.cloneRange() : a, bookmark = {top: _jWin.scrollTop(), rng: a}
      }
    }, this.loadBookmark = function () {
      if (!bSource && bookmark) {
        _this.focus();
        var a = bookmark.rng;
        if (isIE)a.select(); else {
          var b = _this.getSel();
      ...
      var b = _this.getRng(!0), c = _doc.body;
      if (isIE || isIE11)b.moveToElementText(c); else {
        for (var d = a ? "lastChild" : "firstChild"; 3 != c.nodeType && c[d];)c = c[d];
        b.selectNode(c)
      }
      if (b.collapse(a ? !1 : !0), isIE || isIE11)b.select(); else {
        var e = _this.getSel();
      ...
      var b = _this.getSel(), c = _this.getRng(), d = !0;
      ...
      var c = _this.getSel(), d = _this.getRng();
      if (b !== undefined) {
        if (d.item) {
          var e = d.item(0);
      ...
      bookmark = null, "string" != typeof a && "" !== a && (a = _text.value), bSource ? $("#sourceCode", _doc).val(a) : (settings.beforeSetSource && (a = settings.beforeSetSource(a)), a = _this.cleanHTML(a), a = _this.formatXHTML(a), a = _this.processHTML(a, "write"), isIE ? (_doc.body.innerHTML = '<img id="_xhe_temp" width="0" height="0" />' + a, $("#_xhe_temp", _doc).remove()) : _doc.body.innerHTML = a)
      ...
      var e = ' class="Apple-style-span"', f = settings.listFontsize;
      if ("write" === b)a = a.replace(/(<(\/?)(\w+))((?:\s+[\w\-:]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*((\/?)>)/g, function (a, b, c, d, f, g, h) {
        ...
        var i, j = "";
        if ("del" === d)d = "strike"; else if ("img" === d)f = f.replace(/\s+emot\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i, function (a, b) {
          return i = b.match(/^(["']?)(.*)\1/)[2], i = i.split(","), i[1] || (i[1] = i[0], i[0] = ""), "default" === i[0] && (i[0] = ""), settings.emotMark ? a : ""
        }); else if ("a" === d)!f.match(/ href=[^ ]/i) && f.match(/ name=[^ ]/i) && (j += " xhe-anchor"), h && (g = "></a>"); else if ("table" === d && !c) {
        ...
        if (isWebkit)for (var g = [{r: /font-weight\s*:\s*bold;?/gi, t: "strong"}, {
          r: /font-style\s*:\s*italic;?/gi,
          t: "em"
        }, {r: /text-decoration\s*:\s*underline;?/gi, t: "u"}, {
          ...
          a = a.replace(/<(span)(\s+[^>]*?)?\s+class\s*=\s*"Apple-style-span"(\s+[^>]*?)?>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?)<\/\1>/gi, d), a = a.replace(/<(span)(\s+[^>]*?)?\s+class\s*=\s*"Apple-style-span"(\s+[^>]*?)?>(((?!<\1(\s+[^>]*?)?>)[\s\S])*?)<\/\1>/gi, d);
      ...
      function f(a) {
        if (a)for (var b = w.length - 1; b >= 0 && w[b] !== a; b--); else var b = 0;
        if (b >= 0) {
      ...
      var a = settings.beforeSetSource, b = _this.getSource();
      a && (b = a(b));
      var c = "<html><head>" + headHTML + "<title>{#Preview}</title>" + (urlBase ? '<base href="' + urlBase + '"/>' : "") + "</head><body>" + b + "</body></html>", d = window.screen, e = window.open("", "xhePreview", "toolbar=yes,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=" + Math.round(.9 * d.width) + ",height=" + Math.round(.8 * d.height) + ",left=" + Math.round(.05 * d.width)), f = e.document;
      f.open(), f.write(getLang(c)), f.close(), e.focus()
    }, this.toggleFullscreen = function (a) {
      if (bFullscreen !== a) {
        var b = $("#" + idContainer).find(".xheLayout"), c = $("#" + idContainer), d = jQuery.browser.version, e = isIE && (6 == d || 7 == d);
      ...
      var c = $('<div class="xheMenu"></div>'), d = a.length, e = [];
      $.each(a, function (a, b) {
      ...
      var b = settings.listColors, c = $('<div class="xheColor"></div>'), d = [], e = b.length, f = 0;
      $.each(b, function (a, b) {
      ...
      var a = $(getLang(htmlPastetext)), b = $("#xhePastetextValue", a), c = $("#xheSave", a);
      c.click(function () {
        _this.loadBookmark();
        var a = b.val();
      ...
      var a = htmlLink, b = _jDoc.find("a[name]").not("[href]"), c = b.length > 0;
      if (c) {
        var d = [];
        b.each(function () {
      ...
      var e = $(getLang(a)), f = _this.getParent("a"), g = $("#xheLinkText", e), h = $("#xheLinkUrl", e), i = $("#xheLinkTarget", e), j = $("#xheSave", e), k = _this.getSelect();
      ...
      var a = $(getLang(htmlAnchor)), b = _this.getParent("a"), c = $("#xheAnchorName", a), d = $("#xheSave", a);
      if (1 === b.length) {
      ...
      var a = $(getLang(htmlImg)), b = _this.getParent("img"), c = $("#xheImgUrl", a), d = $("#xheImgAlt", a), e = $("#xheImgAlign", a), f = $("#xheImgWidth", a), g = $("#xheImgHeight", a), h = $("#xheImgBorder", a), i = $("#xheImgVspace", a), j = $("#xheImgHspace", a), k = $("#xheSave", a);
      if (1 === b.length) {
        c.val(xheAttr(b, "src")), d.val(b.attr("alt")), e.val(b.attr("align")), f.val(b.attr("width")), g.val(b.attr("height")), h.val(b.attr("border"));
        var l = b.attr("vspace"), m = b.attr("hspace");
      ...
      settings.upImgUrl && _this.uploadInit(c, settings.upImgUrl, settings.upImgExt), k.click(function () {
        ...
        var a = c.val();
        if ("" !== a && "http://" !== a) {
          var k = a.split(" "), l = d.val(), m = e.val(), n = f.val(), o = g.val(), p = h.val(), q = i.val(), r = j.val();
          if (k.length > 1) {
      ...
      var h = $(getLang(b)), i = _this.getParent('embed[type="' + c + '"],embed[classid="' + d + '"]'), j = $("#xhe" + a + "Url", h), k = $("#xhe" + a + "Width", h), l = $("#xhe" + a + "Height", h), m = $("#xheSave", h);
      f && _this.uploadInit(j, f, g), 1 === i.length && (j.val(xheAttr(i, "src")), k.val(i.attr("width")), l.val(i.attr("height"))), m.click(function () {
        _this.loadBookmark();
        var a = j.val();
        if ("" !== a && "http://" !== a) {
          var b = k.val(), f = l.val(), g = /^\d+%?$/;
          g.test(b) || (b = 412), g.test(f) || (f = 300);
          var h = '<embed type="' + c + '" classid="' + d + '" src="xhe_tmpurl"' + e, m = a.split(" ");
          if (m.length > 1) {
            var n, o = h + "", p = [];
      ...
      var c = arrEmots[a], d = emotPath + a + "/", e = 0, f = [], g = "", h = c.width, i = c.height, j = c.line, k = c.count, l = c.list;
      if (k)for (var m = 1; k >= m; m++)e++, f.push("<a href=\"javascript:void('" + m + '\')" style="background-image:url(' + d + m + '.gif);" emot="' + a + "," + m + '" xhev="" title="' + m + '" role="option">&nbsp;</a>'), e % j === 0 && f.push("<br />"); else {
        var n = is(l, "array");
        $.each(l, function (b, c) {
      ...
      var o = j * (h + 12), p = Math.ceil(e / j) * (i + 12), q = .75 * o;
      ...
      var a = $(getLang(htmlTable)), b = $("#xheTableRows", a), c = $("#xheTableColumns", a), d = $("#xheTableHeaders", a), e = $("#xheTableWidth", a), f = $("#xheTableHeight", a), g = $("#xheTableBorder", a), h = $("#xheTableCellSpacing", a), i = $("#xheTableCellPadding", a), j = $("#xheTableAlign", a), k = $("#xheTableCaption", a), l = $("#xheSave", a);
      l.click(function () {
        _this.loadBookmark();
      ...
      var e = $(getLang('<span class="xheUpload"><input type="text" style="visibility:hidden;" tabindex="-1" /><input type="button" value="' + settings.upBtnText + '" class="xheBtn" tabindex="-1" /></span>')), f = $(".xheBtn", e), g = settings.html5Upload, h = g ? settings.upMultiple : 1;
      ...
      var d = (new Date).getTime(), e = "jUploadFrame" + d, f = this, g = $('<iframe name="' + e + '" class="xheHideArea" />').appendTo("body"), h = $('<form action="' + b + '" target="' + e + '" method="post" enctype="multipart/form-data" class="xheHideArea"></form>').appendTo("body"), i = $(a), j = i.clone().attr("disabled", "true");
      return i.before(j).appendTo(h), this.remove = function () {
        null !== f && (j.before(i).remove(), g.remove(), h.remove(), f = null)
      }, this.onLoad = function () {
        var a = g[0].contentWindow.document, b = $(a.body).text();
      ...
      var jContent = $('<iframe frameborder="0" src="' + url.replace(/{editorRoot}/gi, editorRoot) + (/\?/.test(url) ? "&" : "?") + "parenthost=" + location.host + '" style="width:100%;height:100%;display:none;" /><div class="xheModalIfmWait"></div>'), jIframe = jContent.eq(0), jWait = jContent.eq(1);
      ...
      var c = $('<div class="xheDialog"></div>'), d = $(a), e = $("#xheSave", d);
      if (1 === e.length) {
        if (d.find("input[type=text],select").keypress(function (a) {
          ...
          bClickCancel = !1;
          var f = $('<div class="xheFixCancel"></div>').appendTo("body").mousedown(returnFalse), g = _jArea.offset();
          f.css({left: g.left, top: g.top, width: _jArea.outerWidth(), height: _jArea.outerHeight()})
        }
      ...
      var c = _jPanelButton.offset(), d = c.left, e = c.top;
      e += _jPanelButton.outerHeight() - 1, _jCntLine.css({left: d + 1, top: e, width: _jPanelButton.width()}).show();
      ...
      if (b.e)b.e.call(_this); else switch (a = a.toLowerCase()) {
        case"cut":
          try {
        ...
        case"paste":
          try {
            if (_doc.execCommand(a),
                !_doc.queryCommandSupported(a))throw"Error"
          } catch (d) {
  ...
  XHEDITOR.settings = {
    ...
    listFontsize: [{n: "x-small", s: "10px"}, {n: "small", s: "12px"}, {n: "medium", s: "16px"}, {
      n: "large",
      s: "18px"
    }, {n: "x-large", s: "24px"}, {n: "xx-large", s: "32px"}, {n: "-webkit-xxx-large", s: "48px"}]
    ...
    return this.each(function () {
      if ($.nodeName(this, "TEXTAREA"))if (options === !1)this.xheditor && (this.xheditor.remove(), this.xheditor = null); else if (this.xheditor)arrSuccess.push(this.xheditor); else {
    ...
    $("textarea").each(function () {
      var a = $(this), b = a.attr("class");
      b && (b = b.match(/(?:^|\s)xheditor(?:\-(m?full|simple|mini))?(?:\s|$)/i)) && a.xheditor(b[1] ? {tools: b[1]} : null)
    })
  })
}(XHEDITOR, jQuery);