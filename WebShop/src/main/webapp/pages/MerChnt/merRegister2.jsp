...
.RegEpriseInfo .eprise_head_bd {
    height: 50px;
}

.RegEpriseInfo .eprise_head_bd li {
    list-style: none;
    font-size: 14px;
    height: 50px;
    line-height: 50px;
    ...
    cursor: pointer;
    border-bottom-color: #B1D0FF;
}
.RegEpriseInfo .eprise_head_bd li.active {
    list-style: none;
    border-color: #B1D0FF;
    border-bottom-color: #FFF;
    z-index: 1;
    //box-shadow: 0px 0px 4px #B0D0FF;
    background-color: #FFF;
    color: #579AFE;
    position: relative;
}
		 ...
		 <div class="row item reg_item_3" style="display: none;">
			<blockquote class="blockquote blockquote-info RegEpriseInfo">
				...
				<div class="eprise_head_bd">
				  ...
				  <div class="eprise_body_bd">
		            <div class="tab_aera eprise_info" style="display:">
		            <div class="row hide">
						<div class="col-md-6">
							<div class="form-group">
		            ...
		            <div class="tab_aera person_info" style="display:none">
		            
		            <div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label" for="street">客户编号:</label>
								<div class="input-group">
									<div class="input-group-addon">
										<i class="linecons-user"></i>
									</div>
									<input class="form-control" name="custId" id="custId"
										data-validate="required" placeholder="请输入姓名"
										maxlength="60" />
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label" for="street">姓名:</label>
								<div class="input-group">
									<div class="input-group-addon">
										<i class="linecons-user"></i>
									</div>
									<input class="form-control" name="custNm" id="custNm"
										data-validate="required" placeholder="请输入姓名"
										maxlength="60" />
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label" for="door_no">身份证号:</label>
								<div class="input-group">
									<div class="input-group-addon">
										<i class="linecons-user"></i>
									</div>
									<input class="form-control" name="certNo" id="certNo"
										data-validate="required" placeholder="请填写身份证号" />
								</div>
							</div>
						</div>
					</div>
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" name="telephone"
										id="telephone" data-validate="required,minlength[6]"
										placeholder="请输入手机或座机号" />
								</div>
							</div>
						</div>
				...
				<div class="row hide">
					<button type="button" class="btn btn-info" id="grRegistrationBtn">个人注册</button>
					<button type="button" class="btn btn-info" id="qyRegistrationBtn">企业注册</button>
				</div>
