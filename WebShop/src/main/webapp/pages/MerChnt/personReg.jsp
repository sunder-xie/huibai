	        ...
	        <div class="site_nhead">
		        <div class="header">
				    ...
				    <div class="header_center clearfix">
						<a href="＃" target="_self" class="fore2">个人商家进驻</a> 
	...
	<div class="site_frame_main">	
		<div class="site_frame_wrap">
			...
			<div class="row">
				...
				<div class="process_item" id="item_3">
					注册成功 <span class="badge badge-default">3</span>
				</div>
			</div>
		...
		<div class="row item reg_item_2" style="display: none;">
			...
			<div class="div_button">
					...
					<button type="button" class="btn btn-info" id="submitPersonShopBtn" data-nextitem="item_3">提交店铺信息</button>
				</div>
		</div>
...
<!-- Bottom Scripts -->
	...
	<script src="<%=tPath%>/pages/MerChnt/personReg.js?rnd=<%=Math.random()%>" type="text/javascript"></script>
</html>