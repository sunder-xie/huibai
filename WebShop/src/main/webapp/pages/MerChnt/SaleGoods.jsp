...
<head>
	...
	<meta name="description" content="乐汇百材-出售中的商品" />
	<meta name="author" content="hlb" />
			<%@ include file="../common/path.jsp" %>
	<%@ include file="../common/base.jsp" %>
    <base href="<%=tBasePath%>"></base>
	<title>乐汇百材-出售中的商品</title>
	<!-- website -->
    ...
    <div class="site_frame_wrap cmMiddle">
         ...
         <div class="site_frame_cont">
				<div class="bussiness-crumbs" style="position:static">
				   ...
				   <span class="orange">商品管理</span>&nbsp;&nbsp;&gt;&nbsp;&nbsp;出售中的商品
				</div>
                <div id="main">
              <!--商品管理-->
...
<!-- 下架锁定提示 -->
 ...
 <jsp:include page="../HomePages/home_footerbar.jsp" />
	...
	<script src="<%=tPath%>/pages/MerChnt/SaleGoods.js?rnd=<%=Math.random()%>" type="text/javascript"></script>
