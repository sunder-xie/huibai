...
<div class="manger_header">
	<div class="wrap">
		<div class="manger_header_left">
			<a href="<%=tPath%>/index.jsp" target="_blank" class="fore1">
			<img alt="logo" src="<%=tPath%>/images/lhbclogo.png"></a> 
			<a href="<%=tPath%>/pages/User/userCenter.jsp?user_id=<%=userinfo.getId()%>" target="_self" class="fore2">用户中心</a>
		    <a href="<%=tPath%>/index.jsp" target="_blank" class="fore3">返回乐汇首页</a>
		</div>
