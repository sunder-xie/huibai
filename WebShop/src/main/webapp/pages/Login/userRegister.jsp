...
<head>
	...
	<meta name="description" content="乐天百材用户注册" />
	<meta name="author" content="hlb" />
	<title>乐汇百材-用户注册</title>
...
<body>
   ...
   <div class="site_frame_head">
	        <div class="site_nhead">
		        <div class="header">
				    ...
				    <div class="header_center clearfix">
						<a href="＃" target="_self" class="fore2">用户注册</a> 
	...
	<!--进度条-->
	<div class="row">
		<div class="process_item" style="border-left:none">
			注册协议
	...
	<div class="row item">
		<blockquote class="blockquote blockquote-info RegistrationAgreement">
			<p style="text-align: center;"><strong>乐汇百材注册协议</strong></p>
			<p>
...
2.7您具有以下情形之一的，不得向乐汇百材发出签订委托合同的要约：<br/>
...
3.1您与乐汇百材之间的委托合同生效后，在具有乐汇百材受托人身份的同时，您取得特定会员的身份。<br/>
...
3.5出现以下情形之一的，您不得参加只有特定会员才能参加的活动：<br/>

（1）您未与乐汇百材订立生效的委托合同；<br/>
...
（2）您未全面履行与乐汇百材之间的委托合同；<br/>

（3）您未遵守乐汇百材制定、修改或补充的特定活动的规则。<br/>

四、隐私保护<br/>

4.1除本协议4.2条款情况外，乐汇百材保证不对外披露您的有关信息，但下列情况除外：<br/>
...
4.6您同意乐汇百材出现4.4、4.5条款规定情形的，不为对您隐私的侵犯。<br/>
...
5.4如因系统维护或升级的需要而暂停服务，乐汇百材不承担任何责任，但会尽可能事先向您告知。<br/>
...
6.9您同意本协议条款意思的解释权在乐汇百材。<br/>

内蒙古汇百科技有限公司
			</p>
		</blockquote>
		<div class="div_button">
			<button type="button" class="btn btn-info" id="RegistrationAgreement_btn">我已阅读条款</button>
		</div>
	</div>
	<!--用户信息-->
	<div class="row item" style="display:none;">
		<blockquote class="blockquote blockquote-info RegistrationAgreement">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						<label class="control-label" for="street">手机号码</label>
						<div class="input-group">
						<div class="input-group-addon">
							<i class="linecons-mobile"></i>
						</div>
						<input class="form-control" name="userTel" id="userTel" data-validate="required,number" placeholder="请输入手机号" maxlength="11" />
						</div>
					</div>
				</div>
				<div class="col-md-8">
					<div class="form-group">
						<label class="control-label" for="door_no">电子邮件</label>
						<div class="input-group">
						<div class="input-group-addon">
							<i class="linecons-mail"></i>
						</div>
						<input class="form-control" name="userEmail" id="userEmail" data-validate="required,email" placeholder="请输入电子邮件" />
					</div>
					</div>
				</div>
			</div> -->
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						<label class="control-label" for="city">用户名</label>
						<div class="input-group">
							<div class="input-group-addon">
								<i class="linecons-user"></i>
							</div>
							<input type="text" class="form-control" name="username" id="username" data-validate="required,minlength[5]" data-message-minlength="用户名最小5个字符" placeholder="用户名/邮箱/手机号" />
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						<label class="control-label" for="state">密码</label>
						<div class="input-group">
							<div class="input-group-addon">
								<i class="linecons-lock"></i>
							</div>
							<input type="password" class="form-control" name="password" id="password" data-validate="required,minlength[6]" placeholder="请输入用户密码" />
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="password" class="form-control" name="repassword" id="repassword" data-validate="required,equalTo[#password]" data-message-equal-to="密码不匹配" placeholder="确认用户密码"/>
						</div>
					</div>
				</div>
			</div>
			<div class="div_button">
				<button type="button" class="btn btn-info" id="readRegistration">阅读协议</button>
				<button type="button" class="btn btn-info" id="registerBtn">提交注册</button>
			</div>
		</blockquote>
	</div>
	<!--注册结果-->
	<div class="row item" style="display:none;">
		<blockquote class="blockquote blockquote-info RegistrationAgreement" style="text-align: center;">
			<p><strong>注册成功&nbsp;&nbsp;&nbsp;&nbsp;</strong><span id="second_id">5</span>秒后跳转到主页，<a href="<%=request.getContextPath()%>">点击直接跳转</a></p>
		</blockquote>
	</div>
	</div>
	</div>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#RegistrationAgreement_btn").click(function(){
				...
				$(this).parents(".item").next().slideToggle();
			});

			$("#readRegistration").click(function(){
				$(this).parents(".item").slideToggle();
			...
			$("#registerBtn").click(function(){
				...
				/* if(!validTel(userTel)){
					showInfos("请填写正确的手机号码！");
					$("#userTel").focus;
					return;
				}
				if(!validEmail(userEmail)){
					showInfos("请填写正确的用户邮箱！");
					$("#userEmail").focus;
					return;
				} */
				if(username==""){
				...
				if(repassword!=password){
					showInfos("两次输入的密码不一致！");
					$("#password").focus;
					return;
				}
				var param = {userTel:userTel,userEmail:userEmail,username:username,password:password,repassword:repassword};
				$.post("user/Register.action",param,function(data){
					if(data.rspCode=="000000"){
						$("#registerBtn").parents(".item").slideToggle();
						$("#registerBtn").parents(".item").next().slideToggle();
