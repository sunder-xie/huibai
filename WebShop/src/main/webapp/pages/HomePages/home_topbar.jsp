...
<script type="text/javascript">
	...
	$(function(){
		...
		$.post('base/menu/getMenuNav.action',param,function(data){
			...
			<div class="topbar_right">
				<div class="topbar_right_login">
					...
					<%}else{ %>
						...
						<span id="LoginUser" class="hide" loginUserId="<%=userinfo.getId() %>"></span>
				...
				<div class="topbar_right_2">
					...
					<%}else{ %>
						    <a class="topbar_right_2_mylh" href="<%=tPath%>/pages/User/userCenter.jsp?user_id=<%=userinfo.getId()%>">
					<%} %>
					...
					<div class="topbar_right_mylh">
						...
						<%}else{ %>
						    <a href="<%=tPath%>/pages/User/userOrder.jsp?user_id=<%=userinfo.getId()%>" target="_blank">我的订单</a>
						<%} %>
				...
				<div class="topbar_right_5">
					...
					<div class="topbar_right_5_panl">
						<div class="topbar_right_5_panl_left">
							...
							<img src="<%=tPath%>/images/qrcode/app_qrcode.png">
						</div>
				...
				<div class="topbar_right_6">
				    <%if(userinfo == null){%>
						<a class="topbar_right_6_mer" href="<%=tPath%>/pages/MerChnt/MerCenter.jsp">
					<%}else{ %>
					    <a class="topbar_right_6_mer" href="<%=tPath%>/pages/MerChnt/MerCenter.jsp?user_id=<%=userinfo.getId()%>">
					<%} %>
					
					<span class="spans">商家平台</span>
					<span class="arrow"></span></a>
					<div class="topbar_right_mer">
						<a href="<%=tPath%>/pages/Login/merRegGuide.jsp" target="_blank">商家入驻</a></br> 
