...
<head>
    ...
    <%@ include file="pages/common/path.jsp" %>
	  ...
	  <!-- site_frame_top start -->
		<jsp:include page="pages/HomePages/home_topbar.jsp" />
	  	...
	  	<div class="site_frame_main">
		    ...
		    <%@ include file="pages/HomePages/news.jsp" %>
		    </div>
		    <div class="site_frame_wrap">
		  	<%-- <%@ include file="/pages/HomePages/home_special.jsp" %> --%>
		  	<%@ include file="pages/HomePages/channel.jsp" %>
		  	<jsp:include page="pages/HomePages/home_floor.jsp" />
		  	</div>	
		  	
	  	</div>
	  	<!-- <div class="site_frame_foot">"/Users/haibo/Documents/乐天科技/js/鼠标经过图片半透明效果文字滑动显示/index.html"
	  	     <div class="site_foot"> -->
