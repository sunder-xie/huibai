	    ...
	    <div class="row">
	        <div class="col-md-12">
	              ...
	              <div class="form-group">
	                <label for="name" class="col-xs-offset-1 col-xs-2 control-label p0">账号：</label>
	              ...
	              <div class="form-group">
	                <label for="phone" class="col-xs-offset-1 col-xs-2 control-label p0">重复密码：</label>
	                <div class="col-sm-7 col-xs-9">
	                  <input type="password" name="password" class="form-control" id="password" placeholder="请再次输入您的登录密码" autocomplete="off">
	                </div>
	              </div>
	              <!-- <div class="form-group">
